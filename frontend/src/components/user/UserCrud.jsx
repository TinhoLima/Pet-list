...
// Inicio do backend
const baseUrl = 'https://json-crud-23za.vercel.app/users'
    ...
    return this.state.list.map((user) => {
      return (
        <tr key={user.id}>
          ...
          <td data-title="Responsável">{user.name}</td>
          <td data-title="Nome do Pet">{user.pet}</td>
          <td data-title="Espécie">{user.tipo}</td>
          <td data-title="Sexo">{user.sexo}</td>
          <td data-title="Raça">{user.raca}</td>
